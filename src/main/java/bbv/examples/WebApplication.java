...
public class WebApplication {
	...
	CommandLineRunner initializeBooks(BooksService booksService, PublishersService publishersService) {
		return (args) -> {
			Publisher manning = publishersService.addPublisher(Publisher.create("Manning"));
			Publisher prenticeHall = publishersService.addPublisher(Publisher.create("Prentice Hall"));
